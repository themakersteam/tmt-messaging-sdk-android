...
import com.tmt.messagecenter.utils.AudioRecorderUtil;
import com.tmt.messagecenter.utils.DownloadUtils;
import com.tmt.messagecenter.utils.FileUtils;
import com.tmt.messagecenter.utils.LoadingUtils;
...
public class MessageCenterChatFragment extends Fragment implements XmppChatCallbacks, MessageCenterChatAdapter.OnItemClickListener {
    ...
    private MessageCenterChatAdapter mChatAdapter;
     ...
     */
    public static MessageCenterChatFragment newInstance() {
        MessageCenterChatFragment fragment = new MessageCenterChatFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mChatAdapter = new MessageCenterChatAdapter(getActivity(), xmppClient);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_messagecenter_chat, container, false);
    ...
    public void onAttach(Context context) {
        ...
        ((MessageCenterChatActivity)context).setOnBackPressedListener(new MessageCenterChatActivity.onBackPressedListener() {
            @Override
