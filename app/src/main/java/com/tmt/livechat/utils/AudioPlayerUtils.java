...
public class AudioPlayerUtils {
    ...
    public static void setup(final Context context, final ImageView mediaButton, final TextView timer, final SeekBar seekBar, final File file) {
        ...
        mediaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mediaPlayer == null) {
                    setupPlayer(context, seekBar, file);
    ...
    private static void setupPlayer(final Context context, final SeekBar seekBar, File file) {
        mediaPlayer = MediaPlayer.create(context, Uri.parse(file.getPath()));
        mediaPlayer.start();
        lastSelectedAudioPath = file.getName();
        seekBar.setMax(mediaPlayer.getDuration());
        seekBar.setEnabled(true);
    }
